...
//           <p className="text-lg md:text-xl mt-2 opacity-0 animate-fadeIn">We'd love to hear from you</p>
//         </div>
...
//         <section className="px-4 py-8 md:px-6 md:py-12" data-aos="fade-up" data-aos-duration="1500">
