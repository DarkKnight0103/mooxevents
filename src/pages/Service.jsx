    ...
    <>
      ...
      <div className="min-h-screen flex flex-col font-parkin bg-gray-100">
        ...
        >
          ...
          <p className="text-lg md:text-xl mt-2">Best tailored solution for your next event.</p>
        </div>
...
>>>>>>> Stashed changes
        ...
        {/* Service Description */}
        <div className='py-10'>
          <div className="flex flex-col font-parkin items-center justify-center text-center p-6 bg-gray-100 max-w-4xl mx-auto space-y-4">
