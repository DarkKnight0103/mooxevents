...
//             try {
//                 const response = await axios.post(`${ip}/moox_events/api/gallery/get-photos',{user_id:localStorage.getItem('userid')});
...
//
//         try {
//             const response = await axios.post(`${ip}/moox_events/api/gallery/add-photo', {
//                 name: formData.name,
//                 active: true,
...
//         try {
//             const response = await axios.post(`${ip}/moox_events/api/gallery/change-photo-status', {
//                 event_id:clientId,
//                 user_id: localStorage.getItem('userid'),
