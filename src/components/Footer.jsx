...
//     <footer className="bg-gray-800 text-white py-12 w-[70%]">
//       {/* Top Footer Section */}
//       <div className="mx-auto flex flex-row w-full items-start justify-between">
//         <div className="mb-8 w-2/3">
//           <h2 className="text-7xl font-bold text-gray-100">Moox Events <br /> Pvt. Ltd.</h2>
//         </div>
//         <div className="w-1/3">
//           {/* Contact Us Section */}
...
//               <li className="mb-2">Office No. 609, 6th Floor,
// Nakshatra-VIII, Opp. Sun City Apartment,
// Sadhu Vaswani Road, RAJKOT,
// Gujarat (India) – 360005</li>
//               <li className="mb-2">+91 88662 58585 <br />+91 70163 00378 </li>
//               <li className="mb-2"> <a href="mailto:moox.info@gmail.com">moox.info@gmail.com</a></li>
//             </ul>
//           </div>
//         </div>
//       </div>
...
//       <div className="bg-gray-700 py-8 rounded-full mt-3">
//         <div className="mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center">
//           {/* Navigation Links */}
//           <div className="flex flex-wrap flex-row items-center gap-8 justify-center md:mb-0">
//               <ul className="text-gray-300 flex flex-row items-center justify-center gap-4">
//                 <li className="">
...
//             <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transform transition-all duration-300">
//               <FaFacebook size={24} />
//             </a>
//             <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transform transition-all duration-300">
//               <FaTwitter size={24} />
//             </a>
//             <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transform transition-all duration-300">
//               <FaInstagram size={24} />
//             </a>
//             <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transform transition-all duration-300">
//               <FaLinkedin size={24} />
//             </a>
//           </div>
//         </div>
